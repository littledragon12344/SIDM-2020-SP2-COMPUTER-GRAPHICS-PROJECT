...
Mesh* MeshBuilder::GenerateTextureUI(const std::string& meshName, unsigned numRow, unsigned numCol)//same as generateText just that the pivot is center for convienent use(such as rotation)
{
	Vertex v;
	v.normal.Set(0, 0, 1.0f);
	std::vector<Vertex> vertex_buffer_data;
