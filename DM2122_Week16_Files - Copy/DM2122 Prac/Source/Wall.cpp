...
Vector3 Wall::dispAftCollideWithWall(Vector3 position, Vector3 displacement, std::vector<Wall>& walls)
{
	...
	{
		Wall wall = walls[wallIndex]; // Get the current wall in the loop for easier access.
