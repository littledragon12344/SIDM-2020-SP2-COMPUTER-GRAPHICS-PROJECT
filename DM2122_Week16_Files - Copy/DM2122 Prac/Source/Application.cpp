...
void Application::Run()
{
	...
	sceneManager->AddScene(new SceneSkybox());
	sceneManager->AddScene(new SceneCarSelection());
	sceneManager->AddScene(new Minigame());
	sceneManager->AddScene(new SceneInterior());
